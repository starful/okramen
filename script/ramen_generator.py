...
def generate_ramen_article(safe_name, name, lat, lng, address, lang, features, agoda):
    ...
    model_name = 'gemini-flash-latest' # 고품질 장문 생성을 위해 Pro 권장
    ...
    agoda: "{agoda}"
    summary: "High-conversion 3-sentence summary"
    ---
...
if __name__ == "__main__":
    run_generator(limit=2) # 한 번에 25개(50개 파일) 생성